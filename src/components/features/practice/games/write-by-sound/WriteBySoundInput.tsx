...
/**
 * Input section component for Write by Sound game
 */
export const WriteBySoundInput = forwardRef<
  HTMLInputElement,
  WriteBySoundInputProps
>(
  (
    {
      userInput,
...
WriteBySoundInput.displayName = 'WriteBySoundInput';
