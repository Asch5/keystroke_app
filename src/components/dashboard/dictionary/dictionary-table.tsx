            ...
            <tbody>
              {currentWords.map((word) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">{word.translation}</td>
                  <td className="px-6 py-4">{word.category || 'General'}</td>
                  ...
                  <td className="px-6 py-4">
                    <button
                      onClick={() => handleAddToPractice(word.id)}
                    ...
                    >
                      {loading === word.id ? 'Adding...' : 'Add to Practice'}
                    </button>
                  </td>
                </tr>
              ))}
          ...
          >
            <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">
                {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, words.length)}
              </span>{' '}
              of{' '}
              <span className="font-semibold text-gray-900 dark:text-white">
                {words.length}
